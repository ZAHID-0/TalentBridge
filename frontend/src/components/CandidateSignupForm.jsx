  ...
  return (
    <form action="" className='w-full mt-6 space-y-5'>
        ...
        <div className='space-y-2'>
            ...
            <input type="tel" placeholder='+212 600000000' className='w-full rounded-lg border px-4 py-2' />
        </div>
        <div className='space-y-2'>
            <label htmlFor="CV" className='text-black block'>Upload CV</label>
            <input type="file"  className='w-full rounded-lg border px-4 py-2 bg-white' />
        </div>
        <div className='space-y-2'>
